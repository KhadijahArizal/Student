...
class _CompanyState extends State<Company> {
                      ...
                      children: [
                        Row(
                            ...
                            children: [
                              ...
                              _buildDetailStatus(
                                  'Placement Status', user?.status ?? 'Inactive'),
                            ]),
                        ...
                        Row(
                          ...
                          children: [
                            MouseRegion(
                              ...
                              child: Tooltip(
                                message:
                                    'Note\nUpdate this section when your placement is confirmed.',
                                child: Column(
  ...
  void _openPdfFile(String fileUrl) {
        ...
        return AlertDialog(
          ...
          content: RichText(
            text: TextSpan(
              ...
              children: <TextSpan>[
                const TextSpan(
                  text: 'Update this section when your placement is ',
                ),
                TextSpan(
                  text: 'confirmed. ',
                  style: TextStyle(
